...
<html lang="en">
  ...
  <body>
    <div class="container">
        ...
        <a href="{{ route('exposiciones.create')}}" class="btn btn-success">Agregar</a>
        <table class="table">
          <thead>
            <tr>
              <th scope="col">Id</th>
              <th scope="col">Exposocion</th>
          ...
          @foreach ($exposiciones as $exposicion)
            <tr>
              ...
              <td>{{ $exposicion->expo_nombre_evento}}</td>
              <td>{{ $exposicion->obra_titulo}}</td>
              <td>
